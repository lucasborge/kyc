                ...
                <div class="col-md-12 search-list">
                    <div class="table-responsive">
                        <table class="table-bordered">
                            ...
                            ?>
                            <tr class="view-details" for="<?=$client->NRN?>" data-toggle="modal" data-target="#profileModal" data-whatever="<?=$client->NRN?>">
                                <td><?=++$start?></td>
                                <td><?=$client->NRN?></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12 approve-form approve-third">
                        ...
                        <div class="col-md-8 form-group">
                            <div class="label-text telephone-directory" >Land Registry</div><label class="label-text-label telephone-directory-label"><i class='fa fa-check' aria-hidden='true'></i></label>
                        </div>
                        <div class="col-md-12 space-10"></div>
                        <div class="col-md-8 form-group">
