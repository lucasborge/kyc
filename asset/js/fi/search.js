$(document).ready (function () {
	...
	$("#search_users").click (function () {
		...
		if (nrn == "")
			$("#search_form").attr("action", "/fi/searchlist");
		else
			$("#search_form").attr("action", "/fi/searchlist");
	...
	$('#search_button').click (function () {
		location.href = "/fi/searchusers"
	});

	$('.sync-secondary-databases').click (function (event) {
		var nrn = $(this).attr('for');
		location.href = "/fi/sync_secondary?nrn=" + nrn;
	});
	...
	$('#profileModal').on('show.bs.modal', function (event) {
		...
		//var modal = $(this);
		$.ajax({url:"/fi/get_client", type:"post", data:{'nrn':nrn}}).done(function(data) {
